...
OrgChart.localStorage.getItem = function(t) {
    ...
    if (e) {
        ...
        e = e.toISOString(),
        current_localStorage.setItem("to_date", e);
...
OrgChart.localStorage.setItem = function(t, e) {
    try {
        ...
        current_localStorage.clear()) : (console.error("Local storage error code:" + t.code),
        console.error(t))
    }
}
,
...
OrgChart.editUI.prototype.content = function(t, e, r, i, a) {
    ...
    Array.isArray(f.tags) && f.tags.length)
        for (O = 0; O < f.tags.length; O++)
            A.classList.add(f.tags[O]);
            ...
            if (p) {
                ...
                if (s.left || s.right || s.up || s.down) {
                    ...
                    if (null != c) {
                        ...
                        for (var A = o.getNode(c), N = OrgChart.getStParentNodes(A), M = 0; M < N.length; M++) {
...
OrgChart.manager._initNode = function(t, e, r, i, a, n, o) {
    ...
    for (var p = 0; p < t.childrenIds.length; p++) {
        ...
        if (OrgChart.manager._setCollpasedProperty(f, g, c, a, h, i, d),
        !f.collapsed) {
            if (f.parent = t,
            null != f.ppid) {
                var u = e[f.ppid];
            ...
            (-1 != f.tags.indexOf("left-partner") || -1 != f.tags.indexOf("right-partner") || -1 != f.tags.indexOf("partner") || f.parentPartner) && -1 == n.indexOf(t.id) && n.push(t.id),
            t.children.push(f)
        }
    }
    if (t.min || h != OrgChart.action.minimize || (c.all || c.id == t.id) && (t.min = !0),
    ...
    !t.min)
        for (p = 0; p < t.stChildrenIds.length; p++) {
            ...
            t.tags && t.tags.has("filter") || (f.stParent = t,
            t.stChildren.push(f))
        }
    null != i && (t.level = i),
    r && (t.lcn = r);
...
OrgChart.manager._iterate = function(t, e, r, i, a, n, o, l, s, h, c, d) {
    ...
    if (OrgChart.manager._initNode(e, r, s, i, h, c, d),
    ...
    OrgChart.MIXED_LAYOUT_FOR_NODES_WITH_COLLAPSED_CHILDREN && !e.isAssistant && e.parent) {
        if (e.parent && e.parent.children.length && e.parent.children[e.parent.children.length - 1] == e) {
            for (var p = [], f = 0, u = 0, m = 0; m < e.parent.children.length; m++) {
                -1 == (C = e.parent.children[m]).tags.indexOf("partner") && -1 == C.tags.indexOf("left-partner") && -1 == C.tags.indexOf("right-partner") && -1 == C.tags.indexOf("assistant") && 0 == C.children.length ? p.push(C.id) : -1 != C.tags.indexOf("assistant") ? f++ : -1 == C.tags.indexOf("partner") && -1 == C.tags.indexOf("left-partner") && -1 == C.tags.indexOf("right-partner") || u++
            }
        ...
        m = 0; m < e.parent.children.length; m++) {
            var C;
            -1 == (C = e.parent.children[m]).tags.indexOf("partner") && -1 == C.tags.indexOf("left-partner") && -1 == C.tags.indexOf("right-partner") && -1 == C.tags.indexOf("assistant") && 0 == C.childrenIds.length ? p.push(C.id) : -1 != C.tags.indexOf("assistant") ? f++ : -1 == C.tags.indexOf("partner") && -1 == C.tags.indexOf("left-partner") && -1 == C.tags.indexOf("right-partner") || u++
        }
    ...
    for (var b = 0; b < e.stChildren.length; b++) {
        ...
        OrgChart.manager._iterate(t, e.stChildren[b], r, 0, a, n, o, l, O, h, c, d)
    }
    i++;
...
OrgChart.manager.__createNodes = function(t, e, r, i, a, n, o, l) {
    ...
    for (c = 0; c < h.length; c++) {
        ...
        C) {
            var O = n ? n[C.id] : null;
            O && (C.min = O.min),
            C.stChildrenIds.push(f.id)
        } else
            b ? (m && (f.collapsed = m.collapsed,
            f.min = m.min),
            b.childrenIds.push(f.id)) : (m && (f.collapsed = m.collapsed,
            f.min = m.min),
            e.push(f),
            o.push(f.id));
...
OrgChart.manager._createNodes = function(t) {
            ...
            if (d) {
                ...
                if (!f) {
                    if (!OrgChart.isNEU(d.pid))
                        (j = (O = l[d.pid]).childrenIds.indexOf(d.id)) > -1 && O.childrenIds.splice(j, 1);
                    s.push(d)
                }
            }
        }
    ...
    if (i == OrgChart.action.collapse && a && Array.isArray(a.expandIds) && Array.isArray(a.collapseIds))
        for (c = 0; c < a.ids.length; c++) {
            if (a.expandIds.has(a.collapseIds[c]))
                ...
                (C = l[a.collapseIds[c]]) && (C.collapsed = !0)
        }
    ...
    for (c = 0; c < I.length; c++) {
        ...
        for (x = 0; x < C.children.length; x++) {
            (z = C.children[x]).isAssistant ? A.push(z.id) : -1 != z.tags.indexOf("right-partner") ? (z.isPartner = 1,
            z.children = [],
            N.push(z.id)) : -1 != z.tags.indexOf("left-partner") ? (z.isPartner = 2,
            z.children = [],
            M.push(z.id)) : -1 == z.tags.indexOf("partner") || E % 2 ? -1 != z.tags.indexOf("partner") && E % 2 ? (z.isPartner = 2,
            z.children = [],
            M.push(z.id),
            E++) : z.parentPartner ? (L[z.parentPartner.id] || (L[z.parentPartner.id] = []),
            L[z.parentPartner.id].push(z.id)) : A.push(z.id) : (z.isPartner = 1,
            z.children = [],
            N.push(z.id),
            E++)
        }
        ...
        for (x = 0; x < N.length; x++) {
            ...
            for (var R = 0; R < z.childrenIds.length; R++)
                H.push(z.childrenIds[R])
        }
        var F = [];
        for (x = 0; x < M.length; x++) {
            L[(z = l[M[x]]).id] ? C.children.push(z) : C.children.splice(0, 0, z);
            for (R = 0; R < z.childrenIds.length; R++)
                F.push(z.childrenIds[R])
        }
        for (x = 0; x < F.length; x++) {
            (z = l[F[x]]).collapsed || (z.parentPartner = z.parent,
            z.parent = C,
        ...
        for (x = 0; x < H.length; x++) {
            (z = l[H[x]]).collapsed || (z.parentPartner = z.parent,
            z.parent = C,
            z.isChildOfPartner = !0,
            C.children.push(z))
        }
    ...
    for (c = 0; c < k.length; c++) {
        if ((at = r[(C = l[k[c]]).lcn ? C.lcn : "base"]).layout == OrgChart.normal || !S[C.pid])
            for (x = 0; x < C.subLevels; x++) {
                var j, D = new OrgChart.node(C.id + "_sub_level_index_" + x,C.pid,[],"subLevel");
                if (OrgChart.manager._initDinamicNode(D, C.lcn),
                O = C.parent)
                    (j = O.children.indexOf(C)) > -1 && (O.children.splice(j, 1),
                    O.children.splice(j, 0, D)),
                    D.children.push(C),
                    D.parent = O,
                    C.parent = D,
                    l[D.id] = D
    ...
    for (var Y in w) {
        ...
        OrgChart.manager._initDinamicNode(D, O.lcn, !0),
        l[D.id] = D;
        var q = [];
        for (x = O.children.length - 1; x >= 0; x--) {
            (z = O.children[x]).isAssistant ? (z.parent = null,
            O.children.splice(x, 1),
            q.splice(0, 0, z.id)) : z.isPartner || (z.parent && S[z.parent.id] && D && z.parent.id != D.id && (Object.defineProperty(S, D.id, Object.getOwnPropertyDescriptor(S, z.parent.id)),
...
OrgChart.ui = {
    ...
    node: function(t, e, r, i, a, n, o, l, s, h) {
        ...
        var v = "";
        t.lcn && (v = 'lcn="' + t.lcn + '"');
        var x = OrgChart.nodeOpenTag.replace("{lcn}", v).replace("{id}", t.id).replace("{class}", O).replace("{sl}", t.sl).replace("{level}", t.level).replace("{x}", b.x).replace("{y}", b.y)
    ...
    expandCollapseBtn: function(t, e, r, i, a) {
        ...
        return OrgChart.events.publish("renderbuttons", [t, f]),
        f.html
    },
...
OrgChart.prototype._slinks = function(t, e) {
    ...
    function n(e, n, o) {
        ...
        var N = s.join(" ");
        if (l.label) {
            var M = p.label.replace("{x}", S.x).replace("{y}", S.y).replace("{val}", l.label)
        ...
        o && (T = n.id,
        B = e.id),
        r += ("<g " + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace("{from}", T).replace("{to}", B) + p.link.replaceAll("{d}", N) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + N + '" />',
...
OrgChart.events.on("redraw", (function(t, e) {
    if (t.config.miniMap && t.manager.action != OrgChart.action.move) {
        ...
        l.onmousedown = function(t) {
            var e, n, o, h = l.getBoundingClientRect(), c = h.left, d = h.top;
            if (i = parseInt(t.clientX - c),
